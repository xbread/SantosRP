...
NPCMeta.Name = "Food Clerk"

NPCMeta.UID = "food_clerk"

NPCMeta.SubText = "Purchase food or drink here"
...
function NPCMeta:OnPlayerTalk( entNPC, pPlayer )
	...
	GAMEMODE.Net:ShowNPCDialog( pPlayer, "food_clerk" )
...
elseif CLIENT then
	...
	function NPCMeta:RegisterDialogEvents()
		...
		GM.Dialog:RegisterDialog( "food_clerk", self.StartDialog, self )
