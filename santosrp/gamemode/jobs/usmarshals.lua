--[[--------------------
	...
	Not to be distributed, sold, taken, or bought. 
	According to the EULA Included in this folder.
	
	Author and Full Owner of Document: Wren Adler
	Made For and Authorized for: Project Steele
	Copyright: 2018-2020
...
local Job = {}
Job.ID = 19
Job.Enum = "JOB_MARSHALS"
Job.Receives911Messages = false
Job.TeamColor = Color( 255, 0, 0, 255 )
Job.Name = "United States Marshals"
Job.WhitelistName = "marshals"
Job.PlayerModel = {
...
Job.Pay = {
	{ PlayTime = 0, Pay = 100 },
	{ PlayTime = 4 *(60 *60), Pay = 240 },
	{ PlayTime = 12 *(60 *60), Pay = 360 },
	{ PlayTime = 24 *(60 *60), Pay = 540 },
}
...
function Job:OnPlayerJoinJob( pPlayer )
	...
	pPlayer:AddNote("You are now wearing Heavy Armor")
	pPlayer:AddNote("If caught using job when demoted, you will be banned.")
end
...
function Job:OnPlayerQuitJob( pPlayer )
	...
	pPlayer:SetArmor(0)
	pPlayer:AddNote("Your Heavy Armor has been removed.")
